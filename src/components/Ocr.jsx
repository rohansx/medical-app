...
export default function Ocr() {
  ...
  return (
    <>
      ...
      <div>
        <h3 className="mt-3 italic">
          Here's sample reports :{" "}
          <a
            href="https://i.ibb.co/MBDNbnx/OIP-1.jpg"
            className="underline underline-offset-1 italic font-semibold decoration-gray-400">
            Report 1,{" "}
          </a>
          <a
            href="https://i.ibb.co/RTLQDVS/OIP-3.jpg"
            className="underline underline-offset-1 italic font-semibold decoration-gray-400">
            Report 2,{" "}
          </a>
          <a
            href="https://i.ibb.co/7jvrH0R/OIP-2.jpg"
            className="underline underline-offset-1 italic font-semibold decoration-gray-400">
            Report 3{" "}
          </a>
        </h3>
